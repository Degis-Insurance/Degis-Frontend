    ...
    <div class="container">
      <div class="row row-grid align-items-center">
        <div class="col-lg-5 order-md-1">
          ...
          <p class="fw-7 d-g1 fs-18 mb-0">Current Token Price: <span class="fw-7 d-p fs-24"> {{ data.price }}</span></p>
        </div>
...
<!--              <p class="fw-7 d-g1 fs-18 mb-0">Cover 30% off insurance <span class="d-p fs-12">(Price &lt; {{ data.price * 0.7 }})</span></p>-->
              ...
              <p class="fw-7 d-g1 fs-18">My Balance: <span class="d-p">{{ data.mybalance }}</span></p>
            </div>
            <div>
              <base-button @click="buysell(data)">BUY/SELL</base-button>
            </div>
          </div>
        </div>
      </div>
